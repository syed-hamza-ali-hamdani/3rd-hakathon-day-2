...
Object.defineProperty(t,"__esModule",{value:!0})
t.setupQuillEditor=function(t,n,i,s,u,c,d,h,g,f,T,p,E,m,x){const S={"typeahead enter":{key:"enter",handler:()=>!n()}},v={...o.enterKeyBinding,...S},b=new r.default(t.querySelector(`.${e.QUILL_CONTAINER_CLASS}`),{placeholder:i,scrollingContainer:x,formats:["hashtag","mention","guard","bold"],modules:{mention:{actions:{openTypeahead:h,closeTypeahead:g,triggerUnmentionableToast:f,generateNewWorkflowId:T,fireCustomTexteditorTrackingEvent:p,fireControlInteractionEvent:E},trackingData:m},hashtag:{actions:{openTypeahead:h,closeTypeahead:g,generateNewWorkflowId:T,fireCustomTexteditorTrackingEvent:p,fireControlInteractionEvent:E},trackingData:m},keyboard:{bindings:v},history:{delay:50,maxStack:300}}})
delete b.getModule("keyboard").bindings[l.keys.TAB]
b.clipboard.addMatcher("b,strong",a.removeBoldFormatMatcher)
const y=b.container.querySelector(e.QUILL_EDITOR_SELECTOR)
...
c&&b.on("text-change",(()=>{c(b.getContents())}))
d&&b.once("text-change",d)
return b}
